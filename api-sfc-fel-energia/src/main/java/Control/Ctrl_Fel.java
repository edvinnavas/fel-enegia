...
public class Ctrl_Fel implements Serializable {

    private static final long serialVersionUID = 1L;

    List<FEL_DETALLE_DTE> lista_detalle_fel_global = new ArrayList<>();

    public String drive(Connection conn, String cadenasql) {
        String resultado = "";
    ...
    public String Cargar_Doc_Fel(Connection conn, String compania, Long fecha1, Long fecha2) {
        String resultado = "";
        String ambiente = "";
    ...
    private String Cargar_Encabezado_Fel(Connection conn, String ambiente, Integer id_dte, Long fecha_documento, String dcto, Integer an8, Integer doco, String kcoo) {
        ...
        try {
            ...
            cadenasql = "SELECT NVL(TRIM(G.ABTX2),0) FROM " + ambiente + ".F0101@JDENERGIA G WHERE G.ABAN8=" + kcoo.trim();
            stmt = conn.createStatement();
            rs = stmt.executeQuery(cadenasql);
            while (rs.next()) {
    ...
    public String desmarcar_fel(Connection conn, Long id_dte) {
        String resultado = "";
    ...
    public String generar_archivo(Connection conn, String jsonSring) {
        String resultado;
    ...
    public String actualizar_descripcion_producto() {
        ...
        try {
            ...
            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
            conn_jdenergia = DriverManager.getConnection("jdbc:oracle:thin:@//db-jdeenepd:1521/jdepdee1", user, pass);
    ...
    public String fel_modificar_ambiente(Connection conn, Long id_ambiente, Integer valor) {
        String resultado = "";
    ...
    public String documento_autorizar(Connection conn, String path, String ambiente, String kcoo_param) {
        String resultado = "";
