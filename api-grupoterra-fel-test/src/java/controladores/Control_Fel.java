...
public class Control_Fel implements Serializable {
    ...
    public String actualizar_descripcion_producto() {
        ...
        try {
            ...
            conn_gtfacturas = DriverManager.getConnection("jdbc:oracle:thin:@//db-interfase:1521/unopetrol", "gtfacturas_demo", "demo");
            String cadenasql = "SELECT "
                    + "F.AMBIENTE, "
                    + "F.USUARIO, "
                    + "F.CONTRASENA "
            ...
            DriverManager.registerDriver (new oracle.jdbc.driver.OracleDriver());
            conn_jdenergia = DriverManager.getConnection("jdbc:oracle:thin:@//scan-energia-e1:1521/jdepdee1", this.user, this.pass);
